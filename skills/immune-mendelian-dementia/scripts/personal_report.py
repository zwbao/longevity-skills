#!/usr/bin/env python3
"""IPW medication categories from Lindbohm et al."""
...
def match_med(name: str):
    ...
    for key, label in MEDICATIONS.items():
...
def opening():
    return "论文给出的是队列风险比，没有能乘到一个人测量上的系数，所以这次没有算出个人风险比。"
